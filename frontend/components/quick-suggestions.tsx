...
export default function QuickSuggestions({
  ...
  useEffect(() => {
    ...
    if (
      ...
      lowerCaseMessage.includes("puppy")
    ) {
      setSuggestions([
      ...
      lowerCaseMessage.includes("kitten")
    ) {
      setSuggestions([
      ...
      lowerCaseMessage.includes("fish") ||
      lowerCaseMessage.includes("aquarium")
    ) {
      setSuggestions([
      ...
      lowerCaseMessage.includes("bird") ||
      lowerCaseMessage.includes("parrot")
    ) {
      setSuggestions([
        "How to teach my bird to talk?",
        "Best cage setup for birds?",
        "Signs of illness in pet birds?",
      ]);
    } else if (
      lowerCaseMessage.includes("food") ||
      lowerCaseMessage.includes("feeding")
    ) {
      setSuggestions([
