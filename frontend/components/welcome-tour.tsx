  ...
  const steps = [
    {
      ...
      description:
        "Your AI-powered pet care assistant. Let's take a quick tour to help you get started.",
      icon: <Info className="h-8 w-8 text-blue-500" />,
    },
    {
      title: "Ask Anything",
      description:
        "Ask questions about pet care, behavior, training, nutrition, or health concerns.",
      icon: <Info className="h-8 w-8 text-green-500" />,
    },
    {
      title: "Save Knowledge",
      description:
        "Save useful information as knowledge cards for quick reference later.",
      icon: <Info className="h-8 w-8 text-amber-500" />,
    },
    {
      title: "Add Your Pets",
      description:
        "Add your pets' profiles to get personalized advice tailored to their needs.",
